...
router.get('/api/get/data/:url/:suburl?', keystone.middleware.api, routes.api.data.get);
router.get('/api/get/data/select/:url/:selector', keystone.middleware.api, routes.api.data.select);
